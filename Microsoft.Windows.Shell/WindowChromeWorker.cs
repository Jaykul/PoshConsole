...
namespace Microsoft.Windows.Shell
{
    ...
    internal class WindowChromeWorker : DependencyObject
    {
        ...
        //
        // This appears to be a bugbug in DWM related to device bitmap optimizations.  At least on RTM Win7 we can
        // evoke a legacy code path that bypasses the bugbug by calling an esoteric DWM function.  This doesn't affect
        ...
        // Because this isn't documented or supported, it's also not incredibly consistent.  Sometimes some things get updated in
